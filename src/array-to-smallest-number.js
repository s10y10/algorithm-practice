...
function arrayToSmallestNumber(arr) {
  ...
  return arrayToSmallestNumber(left).concat([pointer]).concat(arrayToSmallestNumber(right));
}
const inputValue1 = [10, 2];
const inputValue2 = [3, 30, 34, 5, 9];
test(arrayToSmallestNumber, inputValue1);
test(arrayToSmallestNumber, inputValue2);